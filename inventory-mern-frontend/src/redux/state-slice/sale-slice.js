...
export const saleSlice=createSlice({
    ...
    reducers:{
        ...
        RemoveSaleItem:(state,action)=>{
            state.SaleItemList.slice(action.payload,1)
        },
    }
})

export const {RemoveSaleItem,SetSaleList,SetProductDropDown,SetSaleItemList,SetCustomerDropDown,SetSaleListTotal,OnChangeSaleInput}=saleSlice.actions;
